...
bedTime = 19.5 # Used for advanced rest calories.
...
def showResults(totalCals):
    ...
    print "Breakfast %s - Lunch %s - Dinner %s." %(int(totalCals * (1/(100/mealSizeBreakfast))), int(totalCals * (1/(100/mealSizeLunch))), int(totalCals * (1/(100/mealSizeDinner))))
